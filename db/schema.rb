...
ActiveRecord::Schema[7.1].define(version: 20_241_227_202_127) do
  ...
  create_table 'job_post_locations', force: :cascade do |t|
    t.bigint 'job_post_id', null: false
    t.bigint 'location_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['job_post_id'], name: 'index_job_post_locations_on_job_post_id'
    t.index ['location_id'], name: 'index_job_post_locations_on_location_id'
  end
  ...
  create_table 'job_seniorities', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['job_seniority_code'], name: 'index_job_seniorities_on_job_seniority_code',
                                    unique: true
  end
  ...
  add_foreign_key 'job_post_locations', 'job_posts'
  add_foreign_key 'job_post_locations', 'locations'
