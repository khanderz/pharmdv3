...
ActiveRecord::Schema[7.1].define(version: 20_241_202_205_260) do
  ...
  create_table 'company_domains', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[company_id healthcare_domain_id],
            name: 'index_company_domains_on_company_and_healthcare_domain', unique: true
