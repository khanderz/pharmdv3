...
specialties = {
  ...
  dental: [
    ...
    { key: 'DENTAL_IMPLANTS', value: 'Dental Implants', aliases: ['teeth implants', 'dental prosthetics'] },
    ...
    { key: 'PEDIATRIC_DENTISTRY', value: 'Pediatric Dentistry', aliases: ['children’s dentistry', 'kids dental care'] }
  ],
  dermatology: [
  ...
  endocrinology: [
    { key: 'DIABETES_MANAGEMENT', value: 'Diabetes Management', aliases: ['diabetes care', 'insulin therapy'] },
    { key: 'HORMONE_THERAPY', value: 'Hormone Therapy', aliases: ['hormone replacement', 'endocrine therapy'] }
  ],
  ent: [
    { key: 'HEARING_AIDS', value: 'Hearing Aids', aliases: ['hearing devices', 'hearing technology'] },
    { key: 'HEARING_TESTS', value: 'Hearing Tests', aliases: ['hearing evaluation', 'hearing screening'] }
  ],
  epidemiology: [
    { key: 'DISEASE_CONTROL', value: 'Disease Control', aliases: ['disease prevention', 'epidemiology'] },
  ...
  gastroenterology: [
    { key: 'COLONOSCOPY_SERVICES', value: 'Colonoscopy Services', aliases: ['colon cancer screening', 'colon health'] },
    { key: 'GASTROINTESTINAL_SURGERY', value: 'Gastrointestinal Surgery', aliases: ['GI surgery', 'digestive surgery'] }
  ],
  genetics: [
    { key: 'GENETIC_COUNSELING', value: 'Genetic Counseling', aliases: ['genetic testing', 'genetic health'] },
    { key: 'GENOMIC_HEALTH', value: 'Genomic Health', aliases: ['genomic medicine', 'genetic health'] }
  ],
  geriatrics: [
  ...
  hematology: [
    ...
    { key: 'BLOOD_CANCER_TREATMENT', value: 'Blood Cancer Treatment', aliases: ['leukemia care', 'lymphoma care'] }
  ],
  infectious_disease: [
    { key: 'ANTIVIRAL_TREATMENTS', value: 'Antiviral Treatments', aliases: ['antiviral therapy', 'viral care'] },
    { key: 'INFECTION_CONTROL', value: 'Infection Control', aliases: ['infection prevention', 'disease prevention'] }
  ],
  nephrology: [
  ...
  obstetrics: [
    ...
    { key: 'MATERNAL_HEALTH', value: 'Maternal Health', aliases: ['pregnancy care', 'prenatal care'] }
  ],
  oncology: [
    { key: 'CHEMOTHERAPY', value: 'Chemotherapy', aliases: ['chemo', 'cancer drugs'] },
    { key: 'MEDICAL_ONCOLOGY', value: 'Medical Oncology', aliases: ['cancer medicine', 'oncology treatment'] },
    { key: 'RADIATION_ONCOLOGY', value: 'Radiation Oncology', aliases: ['radiation therapy', 'oncology radiation'] },
    { key: 'SURGICAL_ONCOLOGY', value: 'Surgical Oncology', aliases: ['cancer surgery', 'oncology operations'] }
  ],
  optometry: [
    { key: 'EYE_EXAMS', value: 'Eye Exams', aliases: ['vision tests', 'eye checkup'] },
    { key: 'GLASSES_CONTACTS', value: 'Glasses & Contacts', aliases: ['eyewear', 'vision correction'] }
  ],
  orthopedics: [
    { key: 'JOINT_REPLACEMENT', value: 'Joint Replacement', aliases: ['hip replacement', 'knee replacement'] },
  ...
  podiatry: [
    { key: 'FOOT_SURGERY', value: 'Foot Surgery', aliases: ['foot operation', 'podiatric surgery'] },
    { key: 'ORTHOTICS_PROSTHETICS', value: 'Orthotics & Prosthetics', aliases: ['foot devices', 'foot support'] }
  ],
  primary_care: [
    { key: 'FAMILY_MEDICINE', value: 'Family Medicine', aliases: ['family doctor', 'general practitioner'] },
    { key: 'WELLNESS_EXAMS', value: 'Wellness Exams', aliases: ['annual checkup', 'preventive health'] }
  ],
  psychiatry: [
  ...
  pulmonology: [
    { key: 'ASTHMA_MANAGEMENT', value: 'Asthma Management', aliases: ['asthma care', 'asthma treatment'] },
    { key: 'COPD_CARE', value: 'COPD Care', aliases: ['chronic obstructive pulmonary disease', 'lung disease care'] },
    { key: 'RESPIRATORY_THERAPY', value: 'Respiratory Therapy', aliases: ['breathing therapy', 'lung therapy'] }
  ],
  radiology: [
    { key: 'MRI_IMAGING', value: 'MRI Imaging', aliases: ['magnetic resonance imaging', 'MRI scan'] },
    { key: 'CT_SCAN_SERVICES', value: 'CT Scan Services', aliases: ['computed tomography', 'CT imaging'] }
  ],
  reproductive_health: [
    { key: 'FERTILITY_TREATMENTS', value: 'Fertility Treatments', aliases: ['IVF', 'fertility care'] },
    { key: 'PREGNANCY_CARE', value: 'Pregnancy Care', aliases: ['prenatal care', 'maternal health'] },
    { key: 'SEXUAL_HEALTH_SERVICES', value: 'Sexual Health Services', aliases: ['STI testing', 'sexual wellness'] },
    { key: 'BIRTH_CONTROL_SERVICES', value: 'Birth Control Services', aliases: ['contraception', 'family planning'] }
  ],
  research: [
    { key: 'BIOTECHNOLOGY', value: 'Biotechnology', aliases: ['biotech research', 'bio-research'] },
    { key: 'PHARMACOLOGY_RESEARCH', value: 'Pharmacology Research', aliases: ['drug research', 'medication research'] },
    { key: 'CANCER_RESEARCH', value: 'Cancer Research', aliases: ['oncology research', 'tumor research'] },
  ...
  sleep_health: [
    ...
    { key: 'SLEEP_APNEA_TREATMENT', value: 'Sleep Apnea Treatment', aliases: ['sleep disorder care', 'sleep therapy'] }
  ],
  speech_therapy: [
    { key: 'VOICE_REHABILITATION', value: 'Voice Rehabilitation', aliases: ['voice therapy', 'speech recovery'] },
  ...
  urology: [
    ...
    { key: 'PROSTATE_CARE', value: 'Prostate Care', aliases: ['prostate health', 'prostate disease'] }
  ]
}
