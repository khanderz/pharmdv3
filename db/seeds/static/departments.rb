...
departments = [
  { dept_name: 'Business Development',
    aliases: ['Sales', 'Business Development and Sales', 'Business Development & Sales', 'Finance & Business Operations'] },
  ...
  { dept_name: 'Customer Support',
    aliases: ['Customer Service', 'Client Support', 'Help Desk', 'Customer Operations', 'commercial'] },
  ...
  { dept_name: 'Executive', aliases: ['Leadership', 'Management', 'C-Suite', 'Board of Directors'] },
  ...
  { dept_name: 'IT',
    aliases: ['Information Technology', 'Tech Support', 'Ops/Member Care', 'it operations', 'technology'] },
