...
ats_types = [
  { ats_type_code: 'ASHBYHQ', ats_type_name: 'AshbyHQ',
    domain_matched_url: 'https://jobs.ashbyhq.com/*', redirect_url: 'https://ashbyhq.com/', post_match_url: nil },
  { ats_type_code: 'BAMBOOHR', ats_type_name: 'BambooHR',
    domain_matched_url: 'https://*.bamboohr.com/careers', redirect_url: 'https://www.bamboohr.com/', post_match_url: nil },
  { ats_type_code: 'BREEZYHR', ats_type_name: 'BreezyHR',
    domain_matched_url: 'https://*.breezy.hr', redirect_url: 'https://breezy.hr/', post_match_url: nil },
  # { ats_type_code: 'BUILTIN', ats_type_name: 'BuiltIn' },
  { ats_type_code: 'DOVER', ats_type_name: 'Dover',
    domain_matched_url: 'https://app.dover.com/*/careers/', redirect_url: 'https://dover.com/', post_match_url: nil },
  { ats_type_code: 'EIGHTFOLD', ats_type_name: 'Eightfold',
    domain_matched_url: 'https://*.eightfold.ai/careers', redirect_url: 'https://eightfold.ai/', post_match_url: nil },
  { ats_type_code: 'FOUNTAIN', ats_type_name: 'Fountain',
    domain_matched_url: 'https://*.fountain.com/', redirect_url: 'https://fountain.com/', post_match_url: nil },
  { ats_type_code: 'GEM', ats_type_name: 'Gem', domain_matched_url: 'https://jobs.gem.com/*',
    redirect_url: 'https://gem.com/', post_match_url: nil },
  { ats_type_code: 'GREENHOUSE', ats_type_name: 'Greenhouse',
    domain_matched_url: 'https://job-boards.greenhouse.io/*', redirect_url: 'https://www.greenhouse.io/', post_match_url: 'https://boards-api.greenhouse.io/v1/boards/{ats_id}/jobs?content=true' },
  { ats_type_code: 'HRM_DIRECT', ats_type_name: 'HRM Direct',
    domain_matched_url: 'https://*.hrmdirect.com', redirect_url: 'https://www.hrmdirect.com/', post_match_url: nil },
  # { ats_type_code: 'ICIMS', ats_type_name: 'iCIMS' },
  { ats_type_code: 'JAZZHR', ats_type_name: 'JazzHR',
    domain_matched_url: 'https://*.applytojob.com', redirect_url: 'https://info.jazzhr.com/job-seekers.html', post_match_url: nil },
  { ats_type_code: 'LEVER', ats_type_name: 'Lever', domain_matched_url: 'https://jobs.lever.co/*',
    redirect_url: 'https://www.lever.co/', post_match_url: 'https://api.lever.co/v0/postings/{ats_id}' },
  # { ats_type_code: 'MYWORKDAY', ats_type_name: 'MyWorkday' },
  { ats_type_code: 'PINPOINTHQ', ats_type_name: 'PinpointHQ',
    domain_matched_url: 'https://*.pinpointhq.com', redirect_url: 'https://www.pinpointhq.com/', post_match_url: nil },
  ...
  { ats_type_code: 'RIPPLING', ats_type_name: 'Rippling',
    domain_matched_url: 'https://ats.rippling.com/*', redirect_url: 'https://www.rippling.com/', post_match_url: nil },
  { ats_type_code: 'SCREENLOOP', ats_type_name: 'Screenloop',
    domain_matched_url: 'https://app.screenloop.com/careers/*', redirect_url: 'https://app.screenloop.com/auth/sign_in', post_match_url: nil },
  { ats_type_code: 'SMARTRECRUITERS', ats_type_name: 'SmartRecruiters',
    domain_matched_url: 'https://careers.smartrecruiters.com/*', redirect_url: 'https://jobs.smartrecruiters.com/', post_match_url: nil },
  ...
  { ats_type_code: 'WORKABLE', ats_type_name: 'Workable',
    domain_matched_url: 'https://apply.workable.com/*', redirect_url: 'https://www.workable.com/', post_match_url: nil },
  { ats_type_code: 'YCOMBINATOR', ats_type_name: 'YCombinator',
    domain_matched_url: 'https://ycombinator.com/companies/*/jobs', redirect_url: 'https://www.ycombinator.com/', post_match_url: nil },
