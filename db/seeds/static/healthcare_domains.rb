...
healthcare_domains = [
  ...
  { key: 'FITNESS', value: 'Fitness',
    aliases: ['exercise', 'workout', 'strength training', 'cardio', 'aerobics', 'physical fitness', 'gyms', 'personal training', 'weightlifting', 'bodybuilding', 'fitness classes', 'wellness', 'pilates', 'yoga'] },
  ...
  { key: 'PAIN_MGMT', value: 'Pain Management',
    aliases: ['pain', 'chronic pain', 'multimodal pain management', 'substance use disoder', 'opioid use disorder', 'narcotics', 'opioid abuse', 'substance abuse'] },
  ...
  { key: 'VETERINARY', value: 'Veterinary', aliases: %w[animal pets animals] },
  {
