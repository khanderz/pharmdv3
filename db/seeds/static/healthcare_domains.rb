...
healthcare_domains = [
  ...
  { key: 'CARDIOLOGY', value: 'Cardiology', aliases: ['heart', 'cardiac', 'cardiovascular', 'hypertension', 'heart disease', 'arrhythmia', 'heart attack'] },
  { key: 'DENTAL', value: 'Dental', aliases: ['dentistry', 'oral', 'teeth', 'orthodontics', 'dental', 'cavities', 'gum disease', 'tooth decay'] },
  { key: 'DERMATOLOGY', value: 'Dermatology', aliases: ['skin', 'skincare', 'dermatological', 'dermatology', 'acne', 'eczema', 'psoriasis', 'skin cancer'] },
  { key: 'DIGITAL_HEALTH', value: 'Digital Health', aliases: ['telemedicine', 'virtual', 'e-health', 'telehealth', 'remote health', 'health tech', 'AI based', 'wearables', 'mobile app', 'web app', 'app'] },
  { key: 'EMERGENCY_MEDICINE', value: 'Emergency Medicine', aliases: ['urgent', 'emergency', 'trauma', 'resuscitation', 'critical care'] },
  ...
  { key: 'ENT', value: 'Ear, Nose, and Throat',
    aliases: ['ENT care', 'otolaryngology', 'head and neck', 'hearing', 'auditory', 'nasal', 'throat', 'sinusitis', 'tonsillitis', 'hearing loss'] },
  ...
  { key: 'GERIATRICS', value: 'Geriatrics', aliases: ['elder', 'elderly', 'senior', 'geriatric', 'aging', 'dementia', 'osteoporosis', 'arthritis'] },
  { key: 'HEMATOLOGY', value: 'Hematology', aliases: ['blood', 'hematologic', 'anemia', 'hematology', 'leukemia', 'lymphoma', 'hemophilia'] },
  ...
  { key: 'NEPHROLOGY', value: 'Nephrology', aliases: ['kidney', 'renal', 'nephrology', 'dialysis', 'kidney disease', 'chronic kidney disease', 'ckd'] },
  { key: 'NEUROLOGY', value: 'Neurology', aliases: ['brain', 'neurological', 'neuroscience', 'neurodegenerative', 'epilepsy', 'parkinson\'s disease', 'Alzheimers', 'migraine'] },
  { key: 'NURSING', value: 'Nursing', aliases: ['nurse', 'nursing', 'nurse practitioners', 'patient care'] },
  { key: 'OBSTETRICS', value: 'Obstetrics', aliases: ['maternity', 'prenatal', 'pregnancy', 'pregnant', 'childbirth'] },
  ...
  { key: 'ORTHOPEDICS', value: 'Orthopedics', aliases: ['bone', 'bones', 'musculoskeletal', 'orthopedic', 'joint replacement', 'arthritis', 'osteoporosis'] },
  { key: 'PATHOLOGY', value: 'Pathology',
    aliases: ['disease diagnosis', 'diagnosis', 'testing', 'lab', 'laboratory', 'pathology', 'biopsy', 'tumor analysis'] },
  { key: 'PEDIATRICS', value: 'Pediatrics', aliases: ['child', 'pediatric', 'childcare', 'children', 'developmental disorders'] },
  ...
  { key: 'PODIATRY', value: 'Podiatry', aliases: ['foot', 'podiatric', 'feet', 'orthotics', 'prosthetics', 'bunions', 'plantar fasciitis'] },
  { key: 'PRIMARY_CARE', value: 'Primary Care', aliases: ['general health', 'family', 'primary health', 'wellness', 'preventative', 'vaccinations'] },
  ...
  { key: 'RADIOLOGY', value: 'Radiology', aliases: ['imaging', 'medical imaging', 'diagnostic imaging', 'x-ray', 'tissue imaging', 'ultrasound', 'MRI', 'CT scan'] },
  ...
  { key: 'RHEUMATOLOGY', value: 'Rheumatology', aliases: ['joint health', 'autoimmune', 'rheumatic', 'rheumatoid arthritis', 'lupus', 'spondylitis'] },
  { key: 'SLEEP_HEALTH', value: 'Sleep Health', aliases: ['sleep health', 'sleep disorders', 'insomnia', 'sleep', 'sleep apnea', 'narcolepsy'] },
  ...
  { key: 'SURGERY', value: 'Surgery', aliases: ['surgical', 'operative', "operations", 'procedures', 'surgery', 'minimally invasive', 'heart surgery', 'organ transplant'] },
  { key: 'UROLOGY', value: 'Urology', aliases: ['urinary', 'kidney', 'urological', 'prostate', 'kidney stones', 'incontinence'] }
]
