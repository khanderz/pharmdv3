...
healthcare_domains = [
  ...
  { key: 'ENT', value: 'Ear, Nose, and Throat', aliases: ['ENT care', 'otolaryngology', 'head and neck health', 'hearing health', 'hearing care', 'auditory health'] },
  { key: 'EPIDEMIOLOGY', value: 'Epidemiology', aliases: ['disease control', 'public health', 'epidemiological studies', 'community health', 'health education', 'population health'] },
  { key: "ENVIRONMENTAL HEALTH", value: "Environmental Health", aliases: ["environmental health", "environmental medicine", "environmental science"] },
  ...
  { key: 'OPTOMETRY', value: 'Optometry', aliases: ['eye care', 'vision health', 'ophthalmology', 'eye health', 'vision health', 'ocular health', 'glasses'] },
  ...
  { key: 'PULMONOLOGY', value: 'Pulmonology', aliases: ['lung health', 'respiratory health', 'COPD treatment', 'pulmonary care', 'respiratory therapy'] },
