...
specific_skills = [
  ...
  { skill_code: 'AZURE', skill_name: 'Microsoft Azure', aliases: ['Azure Cloud', 'Azure Services'] },
  ...
  { skill_code: 'DOCKER', skill_name: 'Docker', aliases: ['Containerization', 'Docker Containers'] },
  ...
  { skill_code: 'FLUTTER', skill_name: 'Flutter', aliases: ['Flutter Framework', 'Mobile Development'] },
  { skill_code: 'GOOGLE_CLOUD', skill_name: 'Google Cloud', aliases: ['Google Cloud Platform', 'GCP'] },
  ...
  { skill_code: 'KUBERNETES', skill_name: 'Kubernetes', aliases: ['K8s', 'Container Orchestration'] },
  ...
  { skill_code: 'POWER_BI', skill_name: 'Power BI', aliases: ['Microsoft Power BI', 'Data Visualization'] },
  { skill_code: 'PYTHON', skill_name: 'Python', aliases: ['Python Programming', 'Python Language'] },
  { skill_code: 'R', skill_name: 'R Programming', aliases: ['R Statistical Programming', 'R Language'] },
  ...
  { skill_code: 'SCI_KIT', skill_name: 'Sci-Kit Learn', aliases: ['Machine Learning Sci-Kit', 'Sci-Kit Library'] },
  ...
  { skill_code: 'TABLEAU', skill_name: 'Tableau', aliases: ['Data Visualization Tableau', 'Tableau Software'] },
