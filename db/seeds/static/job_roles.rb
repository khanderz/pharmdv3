job_roles = [
  ...
  { role_name: 'Nurse', aliases: ['Registered Nurse', 'RN', 'Remote Nurse', 'Telehealth Nurse', 'Virtual Care Nurse', 'Nurse Care Manager'], department_names: ['Clinical Team'], team_names: ['Care Operations'] },
