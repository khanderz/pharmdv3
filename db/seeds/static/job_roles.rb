...
job_roles = [
  ...
  { role_name: 'DevOps Engineer', aliases: ['Site Reliability Engineer', 'Cloud Engineer', 'Infrastructure Engineer'],
    department_names: %w[Engineering IT], team_names: %w[DevOps Infrastructure] },
  ...
  { role_name: 'Director of Pharmacy Contracting',
    aliases: ['Pharmacy Contracting Director', 'Pharmacy Contracting Manager', 'Pharmacy Carrier Relations Director'], department_names: ['Pharmacy', 'Business Development'], team_names: ['Pharmacy', 'Business Development'] },
  ...
  { role_name: 'Marketing Specialist', aliases: ['Marketer', 'Digital Marketer', 'Brand Manager', 'Marketing Manager'],
    department_names: ['Marketing'], team_names: ['Marketing'] },
  ...
  { role_name: 'Sales Representative', aliases: ['Sales Rep', 'Account Manager', 'Sales Exec', 'Sales', 'Core Sales'],
    department_names: ['Sales'], team_names: ['Sales'] },
  { role_name: 'Social Worker',
    aliases: ['Licensed Social Worker', 'Remote Social Worker', 'Telehealth Social Worker', 'Virtual Care Social Worker'], department_names: ['Clinical Team'], team_names: ['Care Operations'] },
  ...
  { role_name: 'Technical Support Specialist', aliases: ['Tech Support', 'Support Engineer', 'Helpdesk'],
    department_names: ['IT', 'Engineering', 'Customer Support'], team_names: ['Client Services', 'Tech Support'] },
  { role_name: 'UI/UX Designer', aliases: ['User Experience Designer', 'Interface Designer', 'Product Designer'],
    department_names: ['Design', 'Product Management'], team_names: ['Product'] },
  { role_name: 'Physician',
  ...
  { role_name: 'Chief Information Security Officer', aliases: ['CISO'], department_names: %w[IT Engineering],
    team_names: ['Information Security'] },
  { role_name: 'Integration Engineer',
    aliases: ['Integration Specialist', 'API Engineer', 'Data Integration Engineer'], department_names: %w[Engineering IT], team_names: ['Software Engineering'] },
  ...
  { role_name: 'Chief Financial Officer', aliases: ['CFO'], department_names: ['Finance'],
    team_names: ['Finance'] },
  { role_name: 'Vice President of Engineering', aliases: ['VP Engineering'], department_names: ['Engineering'],
    team_names: ['Software Engineering'] },
  { role_name: 'Vice President of Product', aliases: ['VP Product'], department_names: ['Product Management'],
    team_names: ['Product'] },
  { role_name: 'Vice President of Sales', aliases: ['VP Sales'], department_names: ['Sales'],
    team_names: ['Sales'] },
  { role_name: 'Vice President of Marketing', aliases: ['VP Marketing'], department_names: ['Marketing'],
    team_names: ['Marketing'] },
  { role_name: 'Vice President of Finance',
    aliases: ['VP Financial Operations', 'Vice President, Analytics & Financial Operations', 'Vice President, Financial Planning & Analysis', 'VP Financial Planning & Analysis'], department_names: ['Finance'], team_names: ['Finance'] },
  { role_name: 'Director of Engineering', aliases: ['Engineering Director'], department_names: ['Engineering'],
    team_names: ['Software Engineering'] },
  { role_name: 'Director of Product Management', aliases: ['Product Management Director'],
    department_names: ['Product Management'], team_names: ['Product'] },
  { role_name: 'Director of Data Science', aliases: ['Data Science Director'], department_names: ['Data Science'],
  ...
  { role_name: 'Director of Operations', aliases: ['Operations Director'], department_names: ['Operations'],
    team_names: ['Operations'] },
  ...
  { role_name: 'Head of People', aliases: ['Head of HR', 'HR Lead'], department_names: ['Human Resources'],
