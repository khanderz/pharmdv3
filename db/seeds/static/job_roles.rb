...
job_roles = [
  ...
  { role_name: 'DevOps Engineer', aliases: ['Site Reliability Engineer', 'Cloud Engineer', 'Infrastructure Engineer'], department_names: %w[Engineering IT], team_names: %w[DevOps Infrastructure] },
  ...
  { role_name: 'Graduate', aliases: ['Intern', 'Internship', 'Fellow', 'Resident', 'Trainee', 'Apprentice', 'New Graduate Product Leadership Program', 'new graduate'], department_names: %w[Internship sales], team_names: %w[Internship sales] },
  ...
  { role_name: 'Marketing Manager', aliases: ['Brand Manager', 'Product Marketing Manager'], department_names: ['Marketing'], team_names: ['Marketing'] },
  ...
  { role_name: 'Security Engineer', aliases: ['Information Security Engineer', 'Cybersecurity Engineer', 'Security Analyst', 'Application Security Engineer'], department_names: %w[Engineering IT], team_names: ['Information Security'] },
  ...
  { role_name: 'Solutions Engineer', aliases: ['Pre-Sales Engineer', 'Sales Engineer', 'Technical Sales Engineer', 'Solutions Architect'], department_names: %w[Sales Engineering], team_names: ['Sales', 'Software Engineering'] },
  ...
  # C-Level Roles
  { role_name: 'Associate Director of Business Development', aliases: ['Associate Business Development Director'], department_names: ['Sales', 'Business Development'], team_names: ['Sales', 'Business Development'] },
  { role_name: 'Associate Director of Data Science', aliases: ['Associate Data Science Director'], department_names: ['Data Science'], team_names: ['Data Science'] },
  ...
  { role_name: 'Chief Information Security Officer', aliases: ['CISO'], department_names: %w[IT Engineering], team_names: ['Information Security'] },
  { role_name: 'Chief Marketing Officer', aliases: ['CMO'], department_names: ['Marketing'], team_names: ['Marketing'] },
  { role_name: 'Chief Medical Officer', aliases: ['CMO'], department_names: ['Clinical Team'], team_names: ['Care Operations'] },
  ...
  { role_name: 'Director of Quality', aliases: ['Clinical Quality Assurance'], department_names: ['Quality'], team_names: ['Quality Assurance'] },
  ...
  { role_name: 'Head of DevOps', aliases: ['DevOps Lead'], department_names: %w[IT Engineering], team_names: ['DevOps'] },
  { role_name: 'Head of Growth', aliases: ['Growth Lead'], department_names: %w[Marketing Product], team_names: ['Business Development', 'Marketing'] },
  { role_name: 'Head of People', aliases: ['Head of HR', 'HR Lead'], department_names: ['Human Resources'], team_names: ['Human Resources'] },
  { role_name: 'President of Engineering', aliases: ['President of Engineering'], department_names: ['Engineering'], team_names: ['Software Engineering'] },
  { role_name: 'President of Finance', aliases: ['President of Finance'], department_names: ['Finance'], team_names: ['Finance'] },
  { role_name: 'President of Marketing', aliases: ['President of Marketing'], department_names: ['Marketing'], team_names: ['Marketing'] },
  { role_name: 'President of Product', aliases: ['President of Product'], department_names: ['Product Management'], team_names: ['Product'] },
  { role_name: 'President of Sales', aliases: ['President of Sales'], department_names: ['Sales'], team_names: ['Sales'] },
