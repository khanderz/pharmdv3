...
job_roles = [
  ...
  { role_name: 'Recruiter',
    ...
    department_names: ['Research & Development'], team_names: ['Research & Development'] },
  ...
  { role_name: 'Director of Data Science', aliases: ['Data Science Director'],
    department_names: ['Data Science'], team_names: ['Data Science'] },
  ...
  { role_name: 'President of Product', aliases: ['President of Product'],
    department_names: ['Product Management'], team_names: ['Product'] },
  { role_name: 'President of Sales', aliases: ['President of Sales'], department_names: ['Sales'],
    team_names: ['Sales'] },
