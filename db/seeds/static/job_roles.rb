...
technical_roles = [
  {role_name: 'Computational Scientist', aliases: ['Computational Biologist', 'Computational Chemist', 'Computational Physicist', 'Computational Engineer', 'Computational Analyst', 'Computational Researcher'], department_names: ['Science'], team_names: ['Science']},

  {role_name: 'Data Engineer', aliases: ['Analytics Engineer', 'Data Engineer', 'Data Platform Engineer', 'Data Infrastructure Engineer', 'Data Integration Engineer', 'Data Engineer', 'Data Engineering Specialist'], department_names: ['Engineering', 'Data Science'], team_names: ['Software Engineering', 'Data Science'] },  
  ...
  { role_name: 'Data Scientist',
    ...
    {role_name: 'Designer', aliases: ['Graphic Designer', 'Product Designer', 'UI/UX Designer', 'Visual Designer', 'Web Designer', 'User Experience Designer', 'User Interface Designer', 'Product Designer', 'Product Design Engineer'], department_names: ['Design'], team_names: ['Product'] },

    {role_name: 'Design Engineer', aliases:['Product Engineer'], department_names: ['Engineering'], team_names: ['Software Engineering'] },
