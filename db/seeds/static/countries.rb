...
countries = [
  ...
  { country_code: 'CA', country_name: 'Canada', aliases: ['Great White North'] },
  { country_code: 'CN', country_name: 'China' },
  { country_code: 'CH', country_name: 'Switzerland' },
  { country_code: 'DE', country_name: 'Germany', aliases: ['Deutschland'] },
  { country_code: 'EG', country_name: 'Egypt' },
  { country_code: 'EE', country_name: 'Estonia' },
  { country_code: 'ES', country_name: 'Spain', aliases: ['España'] },
  { country_code: 'FR', country_name: 'France', aliases: ['République Française'] },
  { country_code: 'GB', country_name: 'United Kingdom', aliases: ['UK', 'Britain', 'Great Britain'] },
  ...
  { country_code: 'IN', country_name: 'India', aliases: ['Bharat'] },
  ...
  { country_code: 'US', country_name: 'United States', aliases: ['USA', 'America', 'United States of America'] },
