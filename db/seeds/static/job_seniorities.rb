...
job_seniorities = [
  ...
  { job_seniority_code: 'MANAGER', job_seniority_label: 'Manager',
    aliases: %w[Mgr Supervisor] },
  { job_seniority_code: 'EXECUTIVE', job_seniority_label: 'Executive', aliases: ['Exec'] },
  { job_seniority_code: 'VP', job_seniority_label: 'Vice President',
    aliases: ['Vice Pres', 'VP'] },
  { job_seniority_code: 'C_LEVEL', job_seniority_label: 'C-Level',
    aliases: %w[CEO CTO CFO] }
]
