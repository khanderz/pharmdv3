class Country < ApplicationRecord
    has_many :company_countries, dependent: :destroy has_many :companies, through: :company_countries has_many :job_post_countries, dependent: :destroy has_many :job_posts, through: :job_post_countries has_many :adjudications, as: :adjudicatable, dependent: :destroy validates :country_code, presence: true, uniqueness: true  
