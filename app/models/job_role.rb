...
class JobRole < ApplicationRecord
  ...
  KEYWORD_MAPPINGS = {
    ...
    'Counsel' => %w[legal litigation contracts counsel compliance credentialing attorney paralegal
                    patent contracting compliances],
    ...
    'Medical Coder' => ['medical coding', 'coding specialist', 'medical coder'],
    'Medical Science Liaison' => ['medical science liaison', 'msl', 'medical affairs', 'science liaison', 'value liaison'],
    ...
    'Project Manager' => ['project manager', 'jira', 'projects manager', 'program manager',
                          'program management', 'program leader'],
    ...
    'Solutions Engineer' => ['solutions engineer', 'escalation engineer', 'support engineer',
                             'sales engineer', 'customer engineer', 'solutions consultant'],
    'Systems Engineer' => ['systems architect', 'systems administrator', 'system engineer'],
