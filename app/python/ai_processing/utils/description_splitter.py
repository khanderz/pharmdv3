...
def split_job_description(text: str) -> Dict[str, str]:
    ...
    sections = {
        "summary": ["summary", "overview", "position summary", 'role', 'role description', "about the role"],
        "responsibilities": ["responsibilities", "duties", "key responsibilities", "what you'll do"],
        "qualifications": ["qualifications", "requirements", "skills required", "about you"],
        "benefits": ["benefits", "perks", "compensation", "what you get", "what we offer"]
    }

    all_sections = [alias for section_list in sections.values() for alias in section_list]
