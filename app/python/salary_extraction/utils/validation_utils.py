...
def check_token_label_length(data,tokenized_dataset):
#  length check to test for accuracy
    for example in data:
        ...
        print(f"--------------Aligned Labels ({aligned_label_count}): {aligned_labels}")
        print("-" * 50)

    # Print aligned labels in the tokenized dataset to verify alignment
